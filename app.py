...
with tab2:
  ...
  st.link_button("My Github Repository", "https://github.com/venkatmohans/01-Mourya/") #Edit 4
  ...
  pdf_url = "https://github.com/venkatmohans/01-Mourya/blob/main/titlecards.pdf"
  ...
  if response.status_code == 200:
    ...
    st.download_button(label="Download Report", data=response.content, file_name="titlecards.pdf")
